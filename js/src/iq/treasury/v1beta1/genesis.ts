...
import { Params } from "../../../iq/treasury/v1beta1/treasury";
import { Coin } from "../../../cosmos/base/v1beta1/coin";

export const protobufPackage = "iq.treasury.v1beta1";
...
export const EpochState = {
  encode(message: EpochState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.totalStakedBiq !== "") {
      writer.uint32(34).string(message.totalStakedBiq);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.totalStakedBiq = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): EpochState {
    ...
    if (object.totalStakedBiq !== undefined && object.totalStakedBiq !== null) {
      message.totalStakedBiq = String(object.totalStakedBiq);
    } else {
      message.totalStakedBiq = "";
    }
    return message;
  },
  ...
  toJSON(message: EpochState): unknown {
    ...
    message.totalStakedBiq !== undefined && (obj.totalStakedBiq = message.totalStakedBiq);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<EpochState>): EpochState {
    ...
    if (object.totalStakedBiq !== undefined && object.totalStakedBiq !== null) {
      message.totalStakedBiq = object.totalStakedBiq;
    } else {
      message.totalStakedBiq = "";
    }
    return message;
