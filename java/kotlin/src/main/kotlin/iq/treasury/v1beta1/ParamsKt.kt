...
inline fun params(block: iq.treasury.v1beta1.ParamsKt.Dsl.() -> Unit): iq.treasury.v1beta1.Treasury.Params =
  iq.treasury.v1beta1.ParamsKt.Dsl._create(iq.treasury.v1beta1.Treasury.Params.newBuilder()).apply { block() }._build()
object ParamsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.treasury.v1beta1.Treasury.Params.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.treasury.v1beta1.Treasury.Params.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.treasury.v1beta1.Treasury.Params = _builder.build()

    /**
     * <code>.iq.treasury.v1beta1.PolicyConstraints tax_policy = 1 [(.gogoproto.nullable) = false, (.gogoproto.moretags) = "yaml:&#92;"tax_policy&#92;""];</code>
     */
    var taxPolicy: iq.treasury.v1beta1.Treasury.PolicyConstraints
     ...
     */
    var rewardPolicy: iq.treasury.v1beta1.Treasury.PolicyConstraints
...
@kotlin.jvm.JvmSynthetic
inline fun iq.treasury.v1beta1.Treasury.Params.copy(block: iq.treasury.v1beta1.ParamsKt.Dsl.() -> Unit): iq.treasury.v1beta1.Treasury.Params =
  iq.treasury.v1beta1.ParamsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
