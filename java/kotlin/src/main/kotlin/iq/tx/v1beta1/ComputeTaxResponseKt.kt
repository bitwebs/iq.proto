...
inline fun computeTaxResponse(block: iq.tx.v1beta1.ComputeTaxResponseKt.Dsl.() -> Unit): iq.tx.v1beta1.ServiceOuterClass.ComputeTaxResponse =
  iq.tx.v1beta1.ComputeTaxResponseKt.Dsl._create(iq.tx.v1beta1.ServiceOuterClass.ComputeTaxResponse.newBuilder()).apply { block() }._build()
object ComputeTaxResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.tx.v1beta1.ServiceOuterClass.ComputeTaxResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.tx.v1beta1.ServiceOuterClass.ComputeTaxResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.tx.v1beta1.ServiceOuterClass.ComputeTaxResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.tx.v1beta1.ServiceOuterClass.ComputeTaxResponse.copy(block: iq.tx.v1beta1.ComputeTaxResponseKt.Dsl.() -> Unit): iq.tx.v1beta1.ServiceOuterClass.ComputeTaxResponse =
  iq.tx.v1beta1.ComputeTaxResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
