...
inline fun queryActivesResponse(block: iq.oracle.v1beta1.QueryActivesResponseKt.Dsl.() -> Unit): iq.oracle.v1beta1.QueryOuterClass.QueryActivesResponse =
  iq.oracle.v1beta1.QueryActivesResponseKt.Dsl._create(iq.oracle.v1beta1.QueryOuterClass.QueryActivesResponse.newBuilder()).apply { block() }._build()
object QueryActivesResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.oracle.v1beta1.QueryOuterClass.QueryActivesResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.oracle.v1beta1.QueryOuterClass.QueryActivesResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.oracle.v1beta1.QueryOuterClass.QueryActivesResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.oracle.v1beta1.QueryOuterClass.QueryActivesResponse.copy(block: iq.oracle.v1beta1.QueryActivesResponseKt.Dsl.() -> Unit): iq.oracle.v1beta1.QueryOuterClass.QueryActivesResponse =
  iq.oracle.v1beta1.QueryActivesResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
