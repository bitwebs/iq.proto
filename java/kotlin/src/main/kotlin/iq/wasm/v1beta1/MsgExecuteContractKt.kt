...
inline fun msgExecuteContract(block: iq.wasm.v1beta1.MsgExecuteContractKt.Dsl.() -> Unit): iq.wasm.v1beta1.Tx.MsgExecuteContract =
  iq.wasm.v1beta1.MsgExecuteContractKt.Dsl._create(iq.wasm.v1beta1.Tx.MsgExecuteContract.newBuilder()).apply { block() }._build()
object MsgExecuteContractKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.wasm.v1beta1.Tx.MsgExecuteContract.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.wasm.v1beta1.Tx.MsgExecuteContract.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.wasm.v1beta1.Tx.MsgExecuteContract = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.wasm.v1beta1.Tx.MsgExecuteContract.copy(block: iq.wasm.v1beta1.MsgExecuteContractKt.Dsl.() -> Unit): iq.wasm.v1beta1.Tx.MsgExecuteContract =
  iq.wasm.v1beta1.MsgExecuteContractKt.Dsl._create(this.toBuilder()).apply { block() }._build()
