...
inline fun msgMigrateCode(block: iq.wasm.v1beta1.MsgMigrateCodeKt.Dsl.() -> Unit): iq.wasm.v1beta1.Tx.MsgMigrateCode =
  iq.wasm.v1beta1.MsgMigrateCodeKt.Dsl._create(iq.wasm.v1beta1.Tx.MsgMigrateCode.newBuilder()).apply { block() }._build()
object MsgMigrateCodeKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.wasm.v1beta1.Tx.MsgMigrateCode.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.wasm.v1beta1.Tx.MsgMigrateCode.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.wasm.v1beta1.Tx.MsgMigrateCode = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.wasm.v1beta1.Tx.MsgMigrateCode.copy(block: iq.wasm.v1beta1.MsgMigrateCodeKt.Dsl.() -> Unit): iq.wasm.v1beta1.Tx.MsgMigrateCode =
  iq.wasm.v1beta1.MsgMigrateCodeKt.Dsl._create(this.toBuilder()).apply { block() }._build()
