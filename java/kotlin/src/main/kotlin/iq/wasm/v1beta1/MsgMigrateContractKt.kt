...
inline fun msgMigrateContract(block: iq.wasm.v1beta1.MsgMigrateContractKt.Dsl.() -> Unit): iq.wasm.v1beta1.Tx.MsgMigrateContract =
  iq.wasm.v1beta1.MsgMigrateContractKt.Dsl._create(iq.wasm.v1beta1.Tx.MsgMigrateContract.newBuilder()).apply { block() }._build()
object MsgMigrateContractKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.wasm.v1beta1.Tx.MsgMigrateContract.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.wasm.v1beta1.Tx.MsgMigrateContract.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.wasm.v1beta1.Tx.MsgMigrateContract = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.wasm.v1beta1.Tx.MsgMigrateContract.copy(block: iq.wasm.v1beta1.MsgMigrateContractKt.Dsl.() -> Unit): iq.wasm.v1beta1.Tx.MsgMigrateContract =
  iq.wasm.v1beta1.MsgMigrateContractKt.Dsl._create(this.toBuilder()).apply { block() }._build()
