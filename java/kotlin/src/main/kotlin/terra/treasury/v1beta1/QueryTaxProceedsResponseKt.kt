...
inline fun queryTaxProceedsResponse(block: iq.treasury.v1beta1.QueryTaxProceedsResponseKt.Dsl.() -> Unit): iq.treasury.v1beta1.QueryOuterClass.QueryTaxProceedsResponse =
  iq.treasury.v1beta1.QueryTaxProceedsResponseKt.Dsl._create(iq.treasury.v1beta1.QueryOuterClass.QueryTaxProceedsResponse.newBuilder()).apply { block() }._build()
object QueryTaxProceedsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.treasury.v1beta1.QueryOuterClass.QueryTaxProceedsResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.treasury.v1beta1.QueryOuterClass.QueryTaxProceedsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.treasury.v1beta1.QueryOuterClass.QueryTaxProceedsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.treasury.v1beta1.QueryOuterClass.QueryTaxProceedsResponse.copy(block: iq.treasury.v1beta1.QueryTaxProceedsResponseKt.Dsl.() -> Unit): iq.treasury.v1beta1.QueryOuterClass.QueryTaxProceedsResponse =
  iq.treasury.v1beta1.QueryTaxProceedsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
