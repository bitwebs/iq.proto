...
inline fun epochTaxProceeds(block: iq.treasury.v1beta1.EpochTaxProceedsKt.Dsl.() -> Unit): iq.treasury.v1beta1.Treasury.EpochTaxProceeds =
  iq.treasury.v1beta1.EpochTaxProceedsKt.Dsl._create(iq.treasury.v1beta1.Treasury.EpochTaxProceeds.newBuilder()).apply { block() }._build()
object EpochTaxProceedsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.treasury.v1beta1.Treasury.EpochTaxProceeds.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.treasury.v1beta1.Treasury.EpochTaxProceeds.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.treasury.v1beta1.Treasury.EpochTaxProceeds = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.treasury.v1beta1.Treasury.EpochTaxProceeds.copy(block: iq.treasury.v1beta1.EpochTaxProceedsKt.Dsl.() -> Unit): iq.treasury.v1beta1.Treasury.EpochTaxProceeds =
  iq.treasury.v1beta1.EpochTaxProceedsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
