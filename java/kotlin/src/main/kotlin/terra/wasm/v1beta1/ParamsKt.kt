...
inline fun params(block: iq.wasm.v1beta1.ParamsKt.Dsl.() -> Unit): iq.wasm.v1beta1.Wasm.Params =
  iq.wasm.v1beta1.ParamsKt.Dsl._create(iq.wasm.v1beta1.Wasm.Params.newBuilder()).apply { block() }._build()
object ParamsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.wasm.v1beta1.Wasm.Params.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.wasm.v1beta1.Wasm.Params.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.wasm.v1beta1.Wasm.Params = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.wasm.v1beta1.Wasm.Params.copy(block: iq.wasm.v1beta1.ParamsKt.Dsl.() -> Unit): iq.wasm.v1beta1.Wasm.Params =
  iq.wasm.v1beta1.ParamsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
