...
inline fun params(block: iq.market.v1beta1.ParamsKt.Dsl.() -> Unit): iq.market.v1beta1.Market.Params =
  iq.market.v1beta1.ParamsKt.Dsl._create(iq.market.v1beta1.Market.Params.newBuilder()).apply { block() }._build()
object ParamsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.market.v1beta1.Market.Params.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.market.v1beta1.Market.Params.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.market.v1beta1.Market.Params = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.market.v1beta1.Market.Params.copy(block: iq.market.v1beta1.ParamsKt.Dsl.() -> Unit): iq.market.v1beta1.Market.Params =
  iq.market.v1beta1.ParamsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
