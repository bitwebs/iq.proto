...
inline fun msgSwapSend(block: iq.market.v1beta1.MsgSwapSendKt.Dsl.() -> Unit): iq.market.v1beta1.Tx.MsgSwapSend =
  iq.market.v1beta1.MsgSwapSendKt.Dsl._create(iq.market.v1beta1.Tx.MsgSwapSend.newBuilder()).apply { block() }._build()
object MsgSwapSendKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.market.v1beta1.Tx.MsgSwapSend.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.market.v1beta1.Tx.MsgSwapSend.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.market.v1beta1.Tx.MsgSwapSend = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.market.v1beta1.Tx.MsgSwapSend.copy(block: iq.market.v1beta1.MsgSwapSendKt.Dsl.() -> Unit): iq.market.v1beta1.Tx.MsgSwapSend =
  iq.market.v1beta1.MsgSwapSendKt.Dsl._create(this.toBuilder()).apply { block() }._build()
