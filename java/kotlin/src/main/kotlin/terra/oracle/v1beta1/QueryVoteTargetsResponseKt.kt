...
inline fun queryVoteTargetsResponse(block: iq.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl.() -> Unit): iq.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse =
  iq.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl._create(iq.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.newBuilder()).apply { block() }._build()
object QueryVoteTargetsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    @kotlin.jvm.JvmField private val _builder: iq.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: iq.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): iq.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun iq.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse.copy(block: iq.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl.() -> Unit): iq.oracle.v1beta1.QueryOuterClass.QueryVoteTargetsResponse =
  iq.oracle.v1beta1.QueryVoteTargetsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
