...
import iq.oracle.v1beta1.QueryGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for iq.oracle.v1beta1.Query.
 */
object QueryGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) iq.oracle.v1beta1.Query service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the iq.oracle.v1beta1.Query service based on Kotlin coroutines.
   */
  abstract class QueryCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.ExchangeRate.
     *
    ...
    open suspend fun exchangeRate(request: QueryOuterClass.QueryExchangeRateRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.ExchangeRate is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.ExchangeRates.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun exchangeRates(request: QueryOuterClass.QueryExchangeRatesRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.ExchangeRates is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.TobinTax.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun tobinTax(request: QueryOuterClass.QueryTobinTaxRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.TobinTax is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.TobinTaxes.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun tobinTaxes(request: QueryOuterClass.QueryTobinTaxesRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.TobinTaxes is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.Actives.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun actives(request: QueryOuterClass.QueryActivesRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.Actives is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.VoteTargets.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun voteTargets(request: QueryOuterClass.QueryVoteTargetsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.VoteTargets is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.FeederDelegation.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun feederDelegation(request: QueryOuterClass.QueryFeederDelegationRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.FeederDelegation is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.MissCounter.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun missCounter(request: QueryOuterClass.QueryMissCounterRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.MissCounter is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.AggregatePrevote.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun aggregatePrevote(request: QueryOuterClass.QueryAggregatePrevoteRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.AggregatePrevote is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.AggregatePrevotes.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun aggregatePrevotes(request: QueryOuterClass.QueryAggregatePrevotesRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.AggregatePrevotes is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.AggregateVote.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun aggregateVote(request: QueryOuterClass.QueryAggregateVoteRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.AggregateVote is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.AggregateVotes.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun aggregateVotes(request: QueryOuterClass.QueryAggregateVotesRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.AggregateVotes is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Query.Params.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun params(request: QueryOuterClass.QueryParamsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Query.Params is unimplemented"))
