...
import iq.oracle.v1beta1.MsgGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for iq.oracle.v1beta1.Msg.
 */
object MsgGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) iq.oracle.v1beta1.Msg service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the iq.oracle.v1beta1.Msg service based on Kotlin coroutines.
   */
  abstract class MsgCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Msg.AggregateExchangeRatePrevote.
     *
    ...
    open suspend fun aggregateExchangeRatePrevote(request: Tx.MsgAggregateExchangeRatePrevote):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Msg.AggregateExchangeRatePrevote is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Msg.AggregateExchangeRateVote.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun aggregateExchangeRateVote(request: Tx.MsgAggregateExchangeRateVote):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Msg.AggregateExchangeRateVote is unimplemented"))

    /**
     * Returns the response to an RPC for iq.oracle.v1beta1.Msg.DelegateFeedConsent.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun delegateFeedConsent(request: Tx.MsgDelegateFeedConsent):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.oracle.v1beta1.Msg.DelegateFeedConsent is unimplemented"))
