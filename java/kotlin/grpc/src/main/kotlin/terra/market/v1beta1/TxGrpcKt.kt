...
import iq.market.v1beta1.MsgGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for iq.market.v1beta1.Msg.
 */
object MsgGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) iq.market.v1beta1.Msg service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the iq.market.v1beta1.Msg service based on Kotlin coroutines.
   */
  abstract class MsgCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for iq.market.v1beta1.Msg.Swap.
     *
    ...
    open suspend fun swap(request: Tx.MsgSwap): Tx.MsgSwapResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method iq.market.v1beta1.Msg.Swap is unimplemented"))

    /**
     * Returns the response to an RPC for iq.market.v1beta1.Msg.SwapSend.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun swapSend(request: Tx.MsgSwapSend): Tx.MsgSwapSendResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method iq.market.v1beta1.Msg.SwapSend is unimplemented"))
