...
import iq.wasm.v1beta1.MsgGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for iq.wasm.v1beta1.Msg.
 */
object MsgGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) iq.wasm.v1beta1.Msg service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the iq.wasm.v1beta1.Msg service based on Kotlin coroutines.
   */
  abstract class MsgCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Msg.StoreCode.
     *
    ...
    open suspend fun storeCode(request: Tx.MsgStoreCode): Tx.MsgStoreCodeResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Msg.StoreCode is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Msg.MigrateCode.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun migrateCode(request: Tx.MsgMigrateCode): Tx.MsgMigrateCodeResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Msg.MigrateCode is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Msg.InstantiateContract.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun instantiateContract(request: Tx.MsgInstantiateContract):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Msg.InstantiateContract is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Msg.ExecuteContract.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun executeContract(request: Tx.MsgExecuteContract): Tx.MsgExecuteContractResponse
        = throw
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Msg.ExecuteContract is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Msg.MigrateContract.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun migrateContract(request: Tx.MsgMigrateContract): Tx.MsgMigrateContractResponse
        = throw
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Msg.MigrateContract is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Msg.UpdateContractAdmin.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun updateContractAdmin(request: Tx.MsgUpdateContractAdmin):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Msg.UpdateContractAdmin is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Msg.ClearContractAdmin.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun clearContractAdmin(request: Tx.MsgClearContractAdmin):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Msg.ClearContractAdmin is unimplemented"))
