...
import iq.treasury.v1beta1.QueryGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for iq.treasury.v1beta1.Query.
 */
object QueryGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) iq.treasury.v1beta1.Query service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the iq.treasury.v1beta1.Query service based on Kotlin coroutines.
   */
  abstract class QueryCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.TaxRate.
     *
    ...
    open suspend fun taxRate(request: QueryOuterClass.QueryTaxRateRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.TaxRate is unimplemented"))

    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.TaxCap.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun taxCap(request: QueryOuterClass.QueryTaxCapRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.TaxCap is unimplemented"))

    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.TaxCaps.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun taxCaps(request: QueryOuterClass.QueryTaxCapsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.TaxCaps is unimplemented"))

    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.RewardWeight.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun rewardWeight(request: QueryOuterClass.QueryRewardWeightRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.RewardWeight is unimplemented"))

    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.SeigniorageProceeds.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun seigniorageProceeds(request: QueryOuterClass.QuerySeigniorageProceedsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.SeigniorageProceeds is unimplemented"))

    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.TaxProceeds.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun taxProceeds(request: QueryOuterClass.QueryTaxProceedsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.TaxProceeds is unimplemented"))

    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.Indicators.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun indicators(request: QueryOuterClass.QueryIndicatorsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.Indicators is unimplemented"))

    /**
     * Returns the response to an RPC for iq.treasury.v1beta1.Query.Params.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun params(request: QueryOuterClass.QueryParamsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.treasury.v1beta1.Query.Params is unimplemented"))
