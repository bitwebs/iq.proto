...
import iq.tx.v1beta1.ServiceGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for iq.tx.v1beta1.Service.
 */
object ServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) iq.tx.v1beta1.Service service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the iq.tx.v1beta1.Service service based on Kotlin coroutines.
   */
  abstract class ServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for iq.tx.v1beta1.Service.ComputeTax.
     *
    ...
    open suspend fun computeTax(request: ServiceOuterClass.ComputeTaxRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.tx.v1beta1.Service.ComputeTax is unimplemented"))
