...
import iq.wasm.v1beta1.QueryGrpc.getServiceDescriptor

/**
 * Holder for Kotlin coroutine-based client and server APIs for iq.wasm.v1beta1.Query.
 */
object QueryGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) iq.wasm.v1beta1.Query service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the iq.wasm.v1beta1.Query service based on Kotlin coroutines.
   */
  abstract class QueryCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Query.CodeInfo.
     *
    ...
    open suspend fun codeInfo(request: QueryOuterClass.QueryCodeInfoRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Query.CodeInfo is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Query.ByteCode.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun byteCode(request: QueryOuterClass.QueryByteCodeRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Query.ByteCode is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Query.ContractInfo.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun contractInfo(request: QueryOuterClass.QueryContractInfoRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Query.ContractInfo is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Query.ContractStore.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun contractStore(request: QueryOuterClass.QueryContractStoreRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Query.ContractStore is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Query.RawStore.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun rawStore(request: QueryOuterClass.QueryRawStoreRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Query.RawStore is unimplemented"))

    /**
     * Returns the response to an RPC for iq.wasm.v1beta1.Query.Params.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
    ...
    open suspend fun params(request: QueryOuterClass.QueryParamsRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method iq.wasm.v1beta1.Query.Params is unimplemented"))
